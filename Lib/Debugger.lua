...
debugger.activate    = "f12" -- Löve KeyConstant of the key used to open the console. (Default: 'f4')
debugger.clearPrompt = "f11" -- Löve KeyConstant of the key used to clear the Lua prompt and toggle 'debugger.doTempPrint'. (Default: 'f5')
...
debugger.doTempPrint = false -- Whether or not to print to the screen if the console is closed.
